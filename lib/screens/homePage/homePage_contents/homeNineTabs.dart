...
class NineTabs extends StatefulWidget {
  int colorVal;
  NineTabs(this.colorVal);

  _NineTabsState createState() => _NineTabsState();
}

class _NineTabsState extends State<NineTabs>
