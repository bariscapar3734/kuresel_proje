...
import 'countries_contents/gametopchartstabs.dart';

class CountryTopTabs extends StatefulWidget {
  int colorVal;
  CountryTopTabs(this.colorVal);
  _CountryTopTabsState createState() => _CountryTopTabsState();
}

class _CountryTopTabsState extends State<CountryTopTabs>
